...
DDS_TypeCode * PixyCamConfig_get_typecode(void)
{
    ...
    PixyCamConfig_g_tc._data._sampleAccessInfo =
...
RTIXCdrSampleAccessInfo *PixyCamConfig_get_sample_seq_access_info()
{
    static RTIXCdrSampleAccessInfo PixyCamConfig_g_seqSampleAccessInfo = {
        RTI_XCDR_TYPE_BINDING_CPP, \
        {sizeof(PixyCamConfigSeq),0,0,0}, \
        RTI_XCDR_FALSE, \
        DDS_Sequence_get_member_value_pointer, \
        PixyCamConfigSeq_set_member_element_count, \
        NULL, \
        NULL, \
        NULL \
    };

    return &PixyCamConfig_g_seqSampleAccessInfo;
}

RTIXCdrSampleAccessInfo *PixyCamConfig_get_sample_access_info()
{
    static RTIBool is_initialized = RTI_FALSE;

    PixyCamConfig *sample;

    static RTIXCdrMemberAccessInfo PixyCamConfig_g_memberAccessInfos[1] =
    {RTIXCdrMemberAccessInfo_INITIALIZER};

    static RTIXCdrSampleAccessInfo PixyCamConfig_g_sampleAccessInfo = 
    RTIXCdrSampleAccessInfo_INITIALIZER;
    ...
    PixyCamConfig_g_memberAccessInfos[0].bindingMemberValueOffset[0] = 
    (RTIXCdrUnsignedLong) ((char *)&sample->profileEnabled - (char *)sample);

    PixyCamConfig_g_sampleAccessInfo.memberAccessInfos = 
    PixyCamConfig_g_memberAccessInfos;
    ...
    PixyCamConfig_g_sampleAccessInfo.useGetMemberValueOnlyWithRef =
    RTI_XCDR_TRUE;

    PixyCamConfig_g_sampleAccessInfo.getMemberValuePointerFcn = 
    PixyCamConfig_get_member_value_pointer;

    PixyCamConfig_g_sampleAccessInfo.languageBinding = 
    RTI_XCDR_TYPE_BINDING_CPP ;
...
RTIXCdrTypePlugin *PixyCamConfig_get_type_plugin_info()
{
    ...
    return &PixyCamConfig_g_typePlugin;
}
#endif
